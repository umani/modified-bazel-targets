...
function executeBazelQuery(bazel, query) {
    return __awaiter(this, void 0, void 0, function* () {
        const q = `${bazel} query --keep_going --universe_scope=//... --order_output=no "${query}" 2> /dev/null || true`;
        const targets = (yield util_1.promisify(child_process_1.exec)(q)).stdout;
        const set = new Set();
...
function rules(bazel, input) {
    return executeBazelQuery(bazel, `kind(rule, allrdeps(set(${input.join(" ")})))`);
}
function modifiedBuildFiles(bazel, input) {
    return __awaiter(this, void 0, void 0, function* () {
        const targets = yield executeBazelQuery(bazel, `rbuildfiles(${input.join(", ")})`);
